...
st.image("Images/image1.jfif",width=400)
st.title("Financial Management System")
st.write("A Machine Learning Tool to Detect Frauds in Transactions")
...
nameorigin = st.text_input("Enter a nameorigin", key=1,max_chars=12)
...
nameDest = st.text_input("Enter a name_destination", key=3,max_chars=12)
